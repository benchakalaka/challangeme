...
package com.ik.chalangeme.colpicker;
...
public class ColorPicker extends View {
      ...
      * <p>
      * We use the center of this (quadratic) View as origin of our internal coordinate system. Android uses the upper left corner as origin for the
     ...
     /**
      * Used to change the color of the {@code OpacityBar} used by the {@code SVBar} if there is an change in color.
      * 
      * @param color
