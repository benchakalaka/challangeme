...
public final class CSlideMenuSettings_
    extends CSlideMenuSettings
    implements HasViews, OnViewChangedListener
{
    ...
    public CSlideMenuSettings_(Context context) {
        super(context);
        init_();
    }

    public static CSlideMenuSettings build(Context context) {
        CSlideMenuSettings_ instance = new CSlideMenuSettings_(context);
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View view) {
                        CSlideMenuSettings_.this.settings();
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CSlideMenuSettings_.this.logout();
                    }
        ...
        }
        {
            ...
            if (view!= null) {
                view.setOnClickListener(new OnClickListener() {
                    ...
                    @Override
                    public void onClick(View view) {
                        CSlideMenuSettings_.this.notes();
                    }
